...
class PostTableViewCell: UITableViewCell {
    ...
    func configure(with post: PostModel) {
        logoImageView.image = post.logoImage
        nameLabel.text = post.accountName
        ...
        let deleteAction = UIAlertAction(title: "Удалить публикацию", style: .destructive) { [weak self] _ in
    ...
    private func setUpPostImageView() {
        ...
        NSLayoutConstraint.activate([
            ...
            postImageView.widthAnchor.constraint(equalTo: safeAreaLayoutGuide.widthAnchor),
