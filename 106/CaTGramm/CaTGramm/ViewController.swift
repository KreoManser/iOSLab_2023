...
class ViewController: UIViewController, UICollectionViewDataSource {
    ...
    var datasource = DataManager.OurDataManager.dataSource

    lazy var profilePic: UIImageView = {
        var picture = UIImageView(image: UIImage(named: "myava"))
    ...
    override func viewDidLoad() {
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(title: "topovaya_murmurka", style: .plain, target: self, action: nil)
