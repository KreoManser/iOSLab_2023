...
class ProfileView: UIView, UICollectionViewDelegateFlowLayout {
    ...
    lazy var settingsButton: UIButton = UIButton()
    lazy var plusButton: UIButton = UIButton()
    var didTapSettingsButton: (() -> Void)?
    var didTapfollowingButton: (() -> Void)?
    ...
    private func setUpPlusButton() {
        ...
        NSLayoutConstraint.activate([
            plusButton.topAnchor.constraint(equalTo: self.safeAreaLayoutGuide.topAnchor, constant: 5),
            plusButton.leadingAnchor.constraint(equalTo: userNameLabel.trailingAnchor, constant: 250)
        ])
    }
    private func setUpSettingsButton() {
        addSubview(settingsButton)
        settingsButton.setImage(UIImage(systemName: "text.justify"), for: .normal)
        settingsButton.tintColor = .black
        settingsButton.translatesAutoresizingMaskIntoConstraints = false
        settingsButton.isEnabled = true
        NSLayoutConstraint.activate([
            settingsButton.topAnchor.constraint(equalTo: self.safeAreaLayoutGuide.topAnchor, constant: 5),
            settingsButton.leadingAnchor.constraint(equalTo: plusButton.trailingAnchor, constant: -50)
        ])
    }
}
