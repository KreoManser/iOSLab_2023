...
class ProfileView: UIView, UICollectionViewDelegateFlowLayout {
    ...
    private func setUpAccountNameLabel() {
        ...
        accountNameLabel.text = LogInDataManager.authUser
        ...
        NSLayoutConstraint.activate([
            ...
            accountNameLabel.centerXAnchor.constraint(equalTo: safeAreaLayoutGuide.centerXAnchor, constant: -140)
        ])
    }
    ...
    private func setUpNameLabel() {
        ...
        nameLabel.text = LogInDataManager.authUser.lowercased()
        NSLayoutConstraint.activate([
