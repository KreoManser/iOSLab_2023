...
class DetailTableViewCell: UITableViewCell {
    ...
    lazy var avatarView: UIImageView = {
        ...
        avatarView.image = UIImage(named: "kot3")
    ...
    lazy var buttonIconHeart: UIButton = {
        ...
        buttonIconHeart.setImage(UIImage(named: "comment"), for: .highlighted)
        buttonIconHeart.translatesAutoresizingMaskIntoConstraints = false
        buttonIconHeart.addTarget(self, action: #selector(buttonTapped), for: .touchUpInside)
        return buttonIconHeart
    }()
    @objc func buttonTapped() {
    buttonIconHeart.setImage(UIImage(named: "iconLike"), for: .normal)
    }
    ...
    lazy var commentLabel: UILabel = {
        ...
        commentLabel.text = "Славный_котик: Hello World!"
    ...
    func configure(with publication: DetailPublication) {
        avatarView.image = publication.logoImage
