...
class ProfileView: UIView, UICollectionViewDelegateFlowLayout {
    ...
    private func setUpAccountNameLabel() {
        ...
        accountNameLabel.text = CoreDataManager.shared.getAuthUser()?.login ?? ""
    ...
    private func setUpSubscriptionsCountLabel() {
        ...
        subscriptionsCountLabel.text = "0"
    }
    ...
    private func setUpNameLabel() {
        ...
        nameLabel.text = CoreDataManager.shared.getAuthUser()?.login.lowercased()
        NSLayoutConstraint.activate([
    ...
    private func setUpStoriesCollectionView() {
        ...
        storiesCollectionView.layer.borderWidth = 0.5
        storiesCollectionView.layer.borderColor = UIColor.lightGray.withAlphaComponent(0.4).cgColor
    ...
    private func setUpCollectionView() {
        ...
        collectionView.layer.borderColor = UIColor.lightGray.withAlphaComponent(0.4).cgColor
