...
class ProfileViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        profileDataManager?.postTapped = { [weak self] indexPath in
            let userPostsViewController = UserPostsViewController(indexPath: indexPath)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        profileView?.subscriptionsCountLabel.text = String(coreDataManager.obtainFriendsCount())
        profileView?.postsCountLabel.text = String(coreDataManager.obtainPostsForAuthUser().count)
    }
