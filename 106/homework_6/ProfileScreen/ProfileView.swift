...
class ProfileView: UIView, UICollectionViewDelegateFlowLayout {
    ...
    private func setUpAccountNameLabel() {
        ...
        accountNameLabel.text = "Pushinka.52NGG"
        ...
        NSLayoutConstraint.activate([
            ...
            accountNameLabel.leadingAnchor.constraint(equalTo: safeAreaLayoutGuide.leadingAnchor, constant: 20)
        ])
    }
    ...
    private func setUplogoImageView() {
        ...
        NSLayoutConstraint.activate([
            logoImageView.topAnchor.constraint(equalTo: accountNameLabel.bottomAnchor, constant: 20),
    ...
    private func setUpSubscriptionsCountLabel() {
        ...
        subscriptionsCountLabel.text = "12"
    }
    ...
    private func setUpNameLabel() {
        ...
        nameLabel.text = "Пушинка"
        NSLayoutConstraint.activate([
            nameLabel.topAnchor.constraint(equalTo: logoImageView.bottomAnchor, constant: 10),
            nameLabel.centerXAnchor.constraint(equalTo: logoImageView.centerXAnchor)
        ])
    }
